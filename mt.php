...
get_header(); ?>
	...
	$rows = $newdb->get_results( 'SELECT Organization,Q1A1, Q3A1,
	...
	echo '<table cellpadding = "2" id = "state-db-tables" cellspacing = "2" class = "mt-states-data" align = "center">';
	...
	$rows = $newdb->get_results( 'SELECT Organization, Q1A2, Q3A2,
