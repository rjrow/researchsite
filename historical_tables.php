...
Template Name: Historical tables test
...
get_header(); ?>
	...
	$file_location = bloginfo('template_url'). '/historical_db_connect.php';

	echo $file_location;


	?>
	<script type ="text/javascript" src="<?php bloginfo('template_url'); ?>/js/historical_tables.js"></script>
	<?php
