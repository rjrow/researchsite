...
Template Name: Job Growth Archive MSA all
...
<script type="text/javascript" src="dataTables.numericComma.js"></script>
 ...
 <script type="text/javascript">
	...
	echo '<table cellpadding = "2" id = "db-tables" cellspacing = "2" width = "940" class = "job-growth-msa" align = "center">';
