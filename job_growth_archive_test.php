...
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/hide_selects.js"></script>
	...
	<div id = "radio">
		...
		<input type = "radio" id = "mom" value = "mom" name = "radio">

		<label for ="mom">1 month change</label>

		<input type = "radio" id = "yoy" value = "yoy" name = "radio">

		<label for ="yoy">12 month change</label>

		<input type = "radio" id = "ann" value = "ann" name = "radio">
...
<!-- 			<tr class = "row_state">
			...
			<tr class = "row_area">
				<td> Area: </td>
				<td id = "arealist">
				<select name = "arealist" class = "arealist">
					<?PHP
		...
		<tr class = "row_industry">
			<td> Industry: </td>
			<td>
			<select name = "industrylist" class = "industrylist">
			<?php
