...
//BR Function add 4/22/2014 getting javascript to operate
...
//BR Function add 5/2/2014 getting collapse o matic to get over weird spacing issues
...
function add_my_script() {
   ...
   get_template_directory_uri() . '/js/table_enhancement.js',
