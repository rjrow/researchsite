...
Template Name: GPBC Historical Data
...
get_header(); ?>
	...
	$rows = $newdb->get_results( 'SELECT row_type, Q1, Q2, Q3, Q4, Q5, Q6, Q7

								FROM gpbc_historical;');



	echo '<table id = "state-db-tables" class = "historical-state-db-tables-gpbc" align = "center">';
