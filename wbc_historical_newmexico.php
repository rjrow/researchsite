<?php 
/*
Template Name: WBC Historical New Mexico Data
*/
get_header(); ?>
	...
	$rows = $newdb->get_results( 'SELECT row_type, Q1, Q2, Q3, Q4, Q5
								FROM new_mexico_historical;');

	echo '<table id = "state-db-tables" class = "historical-state-db-tables" align = "center">';
	echo '<thead><tr><th></th>
		  <th>Personal Income ($ millions)</th>
		  <th>Manufacturing Employment ($ millions)</th>
