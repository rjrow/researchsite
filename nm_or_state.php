...
Template Name: NM_OR States Data 
...
get_header(); ?>
	...
	$rows = $newdb->get_results( 'SELECT Organization, Q1A1, Q2A1_mfg, Q3A1,
	...
	$rows = $newdb->get_results( 'SELECT Organization, Q1A2, Q2A2_mfg, Q3A2,
