...
<head>
	...
	<!-- Following includes are for DataTable usage Code 4/22/2014 -Bob Row; studentofdata@gmail.com --> 
	<script type="text/javascript" src="<?php echo bloginfo('template_directory'); ?>/DataTables/media/js/jquery.js"></script>	
	<script type="text/javascript" src="<?php echo bloginfo('template_directory'); ?>/js/jquery.dataTables.js"></script>
	<script type="text/javascript" src="<?php echo bloginfo('template_directory'); ?>/js/table_enhancement.js"></script>
	...
	<?php wp_enqueue_script('table_enhancement'); ?>
