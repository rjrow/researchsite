<?php 
/*
Template Name: WBC Historical Nevada Data
*/
get_header(); ?>
	...
	$rows = $newdb->get_results( 'SELECT row_type, Q1, Q2, Q3, Q4, Q5 FROM '.$state.'_historical;');

	echo '<table id = "state-db-tables" class = "historical-state-db-tables" align = "center">';
	echo '<thead><tr><th></th>
		  <th>Personal Income ($ millions)</th>
		  <th>Gross Gaming Revenues ($ millions)</th>
